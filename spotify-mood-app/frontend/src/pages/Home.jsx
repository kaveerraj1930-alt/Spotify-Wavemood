...
function Home() {
  ...
  const PlaylistCard = ({ title, description, image }) => (
    <div className="group relative bg-[#282828] p-4 rounded-lg hover:bg-[#3E3E3E] transition-all cursor-pointer">
      <div className="relative mb-4">
        ...
        />
        <button className="absolute bottom-2 right-2 w-12 h-12 bg-[#1DB954] rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 translate-y-2 group-hover:translate-y-0 transition-all shadow-xl hover:scale-105">
