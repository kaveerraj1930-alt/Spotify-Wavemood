    ...
    <div className="p-4 md:p-8">
      ...
      <AnimatePresence>
        {notification && (
          ...
          >
            <div className={`mx-4 px-4 py-3 rounded shadow-2xl flex items-center justify-between text-sm ${
            ...
            <div className="flex flex-wrap gap-2">
              {moodHistory.map((mood, index) => (
                <button
                  ...
                  className="px-4 py-2 bg-[#282828] hover:bg-[#3E3E3E] rounded-full text-sm text-gray-300 hover:text-white transition-colors"
                >
                  {mood}
                </button>
              ))}
          ...
          <motion.button
            ...
            className={`w-full max-w-2xl mx-auto block px-8 py-4 rounded-full font-bold text-lg transition-all ${
              !moodInput.trim() || isSubmitting
                ...
                : 'bg-[#1DB954] text-black hover:bg-green-400'
            }`}
          >
          ...
          >
            <div className="flex items-center justify-between mb-6">
              ...
              <motion.button
                ...
                className="px-4 py-2 bg-[#282828] hover:bg-[#3E3E3E] rounded-full text-sm text-white transition-colors font-medium"
              >
                Try Another Mood
              </motion.button>
            </div>
